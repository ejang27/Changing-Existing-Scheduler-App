...
public class ProcessTodoTaskDialog extends FullScreenDialog {
    ...
    private void initGui() {
        ...
        repeatTextView = (TextView) findViewById(R.id.tv_todo_list_repeat);
        repeatTextView.setTextColor(okayButton.getCurrentTextColor());
            ...
            public void onClick(View v) {
                ...
                repeatDialog.setCallback(new RepeatDialog.RepeatCallback() {
                    ...
                    public void removeRepeat() {
                        reminderTime = -1;
                        TextView repeatTextView = (TextView) findViewById(R.id.tv_todo_list_repeat);
                        repeatTextView.setText(getContext().getResources().getString(R.string.no_repeat));
                    }
                });
                repeatDialog.show();
            }
